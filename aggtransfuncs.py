...
class Tftrans(object):
	...
	def __init__(self, data, input_scaling_vars, input_encoding_vars, output_vars, partition_name = 'partition'):
		self.input_vars = input_scaling_vars + input_encoding_vars
		self.output_vars = output_vars
		self.input_scaling_vars = input_scaling_vars
		self.input_encoding_vars = input_encoding_vars
		...
		self.outputs_array = np.array(data[output_vars])
